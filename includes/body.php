                                   ...
                                   <div class='destination'>
                                     ...
                                     <div class='text p-3'>
                                       ...
                                       <p class='bottom-area d-flex'>
                                         <span><i class='icon-map-o'></i> Arjit Books</span> 
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_1.jpg);">
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            ...
            <span class="subheading">More than 5,000 Tech-Participants</span>
          </div>
        </div>
		          ...
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                ...
		                <span>Number of Shares on Media Platform</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="6400">0</strong>
      ...
      <div class="container">
        <div class="row justify-content-start">
          ...
          <div class="col-md-6 heading-section ftco-animate">
            ...
            <h2 class="mb-4 pb-3"><strong>Our</strong> Tech-Giants</h2>
		              ...
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Dr Arjit Mohapatra is currently working as a Professor & Principal, Dept. of Computer Science and Engineering since 2010. His research and professional career spans about 15 years .</p>
		                    <p class="name">Dr. Arjit Mohapatra</p>
